...
func TestInitializeLoggingClientByFile(test *testing.T) {
	var loggingConfig = common.LoggingInfo{File: "./device-dcs.log", EnableRemote: false}
...
func TestCheckServiceAvailableByPingWithTimeoutError(test *testing.T) {
	...
	common.CurrentConfig = &config
	common.LoggingClient = logger.NewClient("test_service", false, "./device-dcs.log", "DEBUG")
